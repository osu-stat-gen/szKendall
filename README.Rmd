...
The goal of szKendall is to measure the dissimilarity between two single cells based on Hi-C data, accounting for the discrepancies in structural zero positions.
