...
szK1 <- szKendall1.diss(contacts=contacts,dist.method="szKendall1")
...
scHiC_hm_dist(szK, title="szK")

# t-SNE 2D projection
scHiC_tSNE_dist(szK, cell_type=cell.type, seed=1234, title="szK", alpha_value=1)

# UMAP 2D projection
scHiC_UMAP_dist(szK, cell_type=cell.type, seed=1234, main="szK", alpha_value=1)
```
